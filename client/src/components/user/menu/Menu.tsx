  ...
  return (
    <ProfileMenu>
      ...
      <ProfileLink to="/user/igtv">
        <MenuWrapper showFocus={pathname === "/user/igtv"}>
          <svg
            className={
              pathname === "/user/igtv" ? "svg_focus" : "svg_not_focus"
            }
            viewBox="0 0 48 48"
          >
          ...
          <Menu className={pathname === "/user/igtv" ? "" : "on"}>IGTV</Menu>
        </MenuWrapper>
      </ProfileLink>
      <ProfileLink to="/user/saved">
        <MenuWrapper showFocus={pathname === "/user/saved"}>
          <svg
            className={
              pathname === "/user/saved" ? "svg_focus" : "svg_not_focus"
            }
            viewBox="0 0 48 48"
          >
      ...
      <ProfileLink to="/user/tagged">
        <MenuWrapper showFocus={pathname === "/user/tagged"}>
          <svg
            className={
              pathname === "/user/tagged" ? "svg_focus" : "svg_not_focus"
            }
            viewBox="0 0 48 48"
          >
          ...
          <Menu className={pathname === "/user/tagged" ? "" : "on"}>
            Tagged
          </Menu>
        </MenuWrapper>
      </ProfileLink>
